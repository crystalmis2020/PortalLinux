...
/*****************************
 * Current RouterOS V 6.45.7 (November 6, 2019)
...
class Routeros_api
{
    ...
    var $ip = '128.0.100.1';    // IP of miktotik
    var $login = 'Alkaloid';    // username of miktotik
    var $password = 'alkaloid'; // password of miktotik
                ...
                if ($RESPONSE[0] == '!done') {
                    ...
                    if (preg_match_all('/[^=]+/i', $RESPONSE[1], $MATCHES)) {
                        if ($MATCHES[0][0] == 'ret' && strlen($MATCHES[0][1]) == 32) {
							...
							$this->write('=password=' . $password); //added November 6, 2019 https://forum.mikrotik.com/viewtopic.php?t=149738
                            $RESPONSE = $this->read(false);
                            if ($RESPONSE[0] == '!done') {
                                $this->connected = true;
                                break;
