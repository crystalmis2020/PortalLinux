...
<head>
    ...
    <title>Administrative Panel | CSCI Integrated System</title>
    @if(Request::route()->getName() == 'requestAdminDash')
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="{{route('requestAdminDash')}}"><img src="{{asset('images/rfi/icon/logo.png')}}" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li><a href="{{route('requestAdminDash')}}"><i class="ti-dashboard"></i> <span>Dashboard</span></a></li>
                            <li><a href="{{route('requestAdminHistory')}}"><i class="fa fa-history"></i> <span>History</span></a></li>
                            <li><a href="{{route('requestAdminAccess')}}"><i class="fa fa-barcode"></i> <span>Access Code (DB)</span></a></li>
                            <li><a href="{{route('requestAdminAccessMT')}}"><i class="fa fa-barcode"></i> <span>Access Code (MT)</span></a></li>
                        </ul>
                    </nav>
                </div>
            </div>
